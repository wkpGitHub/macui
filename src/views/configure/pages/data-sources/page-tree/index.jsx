  ...
  setup (props, { emit }) {
    ...
    const getPages = () => {
      dataInfoService.tree({ withBasic: false }).then(res => {
        ...
        // 获取firstLeaf
        const firstLeaf = findFirstLeaf(children ?? [])
        nextTick().then(() => {
    ...
    const { dialog, dialogTitle, dataModel, dataModelFieldList, handleCommand, saveDataModel, handleClick } = useDataModel(getPages)
