...
export const componentsGroupList = [
  ...
  },
  {
    ...
    components: [
      ...
      { type: 'text', icon: 'el-icon-tickets', label: '展示值', hideLabel: true, defaultValue: '这里是文字', fontWeight: 'normal', fontSize: 14, textAlign: 'left' },
      { type: 'img', icon: 'el-icon-edit', label: '图片' },
      { type: 'span', icon: 'el-icon-edit', label: '文字' },
