...
import { PalettePlugin, StructurePlugin, CodeSourcePlugin, FieldConfigurePlugin, PageDrawPlugin } from '../../plugins';
...
var index = {
  ...
  setup(props, {
    ...
    }), new StructurePlugin(), new CodeSourcePlugin(), new FieldConfigurePlugin(), new PageDrawPlugin()];
