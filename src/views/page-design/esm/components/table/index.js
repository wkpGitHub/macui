...
import { PalettePlugin, StructurePlugin, CodeSourcePlugin, FieldConfigurePlugin, FormDrawPlugin, FormPreviewPlugin, TableConfigurePlugin } from '../../plugins';
...
var index = {
  ...
  setup(props, {
    ...
    }), new StructurePlugin(), new CodeSourcePlugin(), new FieldConfigurePlugin(), new FormDrawPlugin(), new FormPreviewPlugin(), new TableConfigurePlugin()];
