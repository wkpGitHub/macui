  ...
  setup(props, {
    ...
    const FormContent = ({
      ...
      const formContentProps = {
        ...
        onCopy: () => copyOptionChild(optionIndex, childIndex),
        // 内部自由的copy
        onSelectItem: (val) => selectItem(val)
      };
      return h(FormDrawingContent, formContentProps);
    };
    return () => createVNode(CipFormLayout, {
      ...
      item: ({
        ...
        deleteOptionChild,
        updateOptionChild
      }) => createVNode(VueDraggable, {
        "modelValue": children,
        "onUpdate:modelValue": (val) => {
          updateOptionChildren(optionIndex, val);
        },
        "itemKey": "id",
        "group": {
          name: "components",
        ...
        "componentData": {
          class: [ns.e("item"), {
            [ns.em("item", "empty")]: children.length === 0
          }],
          style: {}
        },
