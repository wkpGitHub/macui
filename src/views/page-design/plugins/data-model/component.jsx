...
export default {
  ...
  setup (props, { emit }) {
    ...
    function getStaticData () {
      const temp = (drDesign.schema.dataModel || []).find(v => v.value === 'private')?.children || []
    ...
    function setStaticData (data) {
      (drDesign.schema.dataModel || []).find(v => v.value === 'private').children = data
    }
